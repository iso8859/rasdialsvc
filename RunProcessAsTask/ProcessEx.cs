...
namespace RunProcessAsTask
{
    ...
    {
        public static async Task<ProcessResults> RunAsync(ProcessStartInfo processStartInfo, List<string> standardOutput, List<string> standardError, List<string> standardInput, CancellationToken cancellationToken)
        {
                ...
                }))
            {
                ...
                else
                {
                    ...
                    if (standardInput != null)
                    {
                        foreach (string s in standardInput)
