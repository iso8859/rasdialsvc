...
namespace RunProcessAsTask
{
    ...
    public partial class ProcessEx
    {
        ...
        public static Task<ProcessResults> RunAsync(string fileName, string arguments, List<string> stdinput, CancellationToken cancellationToken)
            => RunAsync(new ProcessStartInfo(fileName, arguments), new List<string>(), new List<string>(), stdinput, cancellationToken);
        ...
        public static Task<ProcessResults> RunAsync(ProcessStartInfo processStartInfo, CancellationToken cancellationToken)
            => RunAsync(processStartInfo, new List<string>(), new List<string>(), null, cancellationToken);
    }
}
